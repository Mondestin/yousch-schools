...
test('authenticated staff can visit school stub pages', function (string $uri, string $component) {
    ...
    ['/evaluations/devoirs', 'assessments/index'],
    ['/evaluations/compositions', 'assessments/index'],
    ['/evaluations/examens', 'assessments/index'],
    ['/evaluations/fenetres', 'assessments/windows'],
